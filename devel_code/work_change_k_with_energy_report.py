...
times, x, power, work, heat, delta_U, energy = many_sims_parallel(tot_sims=1000000)
...
animate_simulation(times, work,x_range=[-1,1], y_range=[0,4], x_label='W', y_label='P(W,t)', show_x_eq_distrib=False)


# In[29]:


np.average(delta_U,axis=0)


# In[31]:


np.average(heat+work, axis=0)


# In[36]:


np.average(energy, axis=0)


# In[37]:


px.line(x=times, y=np.average(energy, axis=0))
